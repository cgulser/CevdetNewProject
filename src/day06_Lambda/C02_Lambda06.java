...
public class C02_Lambda06 {

    public static void main(String[] args) throws IOException {
        //TASK 01 --> haluk.txt dosyasini okuyunuz.(Console'a yazdiriniz)
        System.out.println("\n*** haluk.txt dosyasini okuyunuz -->  ");
        Files.lines(Paths.get("src/day06_Lambda/Haluk.txt")).//Files class'dan lines() method call edilerek data
        ...
        Files.lines(Paths.get("src/day06_Lambda/Haluk.txt")).
